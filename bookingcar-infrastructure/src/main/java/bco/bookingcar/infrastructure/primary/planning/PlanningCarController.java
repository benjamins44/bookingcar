...
public class PlanningCarController {
    ...
    private final GetPlanningCarPresenter<List<PlanningCarResource>> getPlanningCarPresenter;
    ...
    public ResponseEntity<List<PlanningCarResource>> getAllByPeriod(PeriodResource periodResource) {
        getPlanningCarUseCase.execute(GetPlanningCarRequest.builder().period(periodResource.toDomain()).build(), getPlanningCarPresenter);

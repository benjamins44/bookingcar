...
public class AppError {
    ...
    public AppError(final String apiVersion, final String status, final String message, final String domain,
                    final String reason, final String errorMessage, final String errorReportUri) {
        this.apiVersion = apiVersion;
        this.error = new ErrorBlock(status, message, domain, reason, errorMessage, errorReportUri);
    }


    public static AppError from(final String apiVersion,
